...
namespace Library
{
    public abstract class AbstractRoomSaver : AbstractIdGetter
    {
        ...
        public void AttackByPlayingWithMissile(AbstractPlayer player, string name, int vessel, int x, int y)
        {
            this.GetRoomByPlaying(player).AttackByNameWithOneMissile(player, name, vessel, x, y);
        }
        public void AttackByPlayingWithLoad(AbstractPlayer player, string name, int vessel, int x, int y)
        {
            this.GetRoomByPlaying(player).AttackByNameWithLoad(player, name, vessel, x, y);
        }
